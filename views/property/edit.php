...
<form class="form-horizontal" method="post" id="addproperty" enctype="multipart/form-data" onsubmit="return validatepopertyupdateform();">
    <div class="control-group">
        ...
        <div class="controls">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> name="propertyfor" id="propertyfor" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
    ...
    <div class="control-group " >
        ...
        <div class="controls ">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> name="propertytype" id="propertytype" onchange="propertyType(this)" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
                <option value="">--Select--</option>
                <?php
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <label class="radio-inline">
                <input <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> <?php echo ('new' == $properties['transType']) ? 'checked' : '' ?> type="radio" id="newproperty" name="transactiontype" value="new"> New Property
            </label>
            <label class="radio-inline">
                <input <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?>  <?php echo ('resale' == $properties['transType']) ? 'checked' : '' ?> type="radio" id="relsale" name="transactiontype" value="resale" > Resale
            </label>
        </div>
    </div>
    <div class="control-group resi" >
        ...
        <div class="controls ">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> name="bedrooms" id="bedrooms" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
                <option value="">--Select--</option>
                <?php
    ...
    <div class="control-group resi" >
        ...
        <div class="controls ">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> name="bathrooms" id="bathrooms" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
                <option value="">--Select--</option>
                <?php
                foreach ($rooms as $room) {
                    ?> 
    ...
    <div class="control-group resi" >
        ...
        <div class="controls ">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> name="furnished" id="furnished" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
                <option value="">--Select--</option>
    ...
    <div class="control-group resi">
        ...
        <div class="controls">
            <input <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> value="<?php echo $properties['coveredArea'] ?>"  type="text"  id="coveredarea" name="coveredarea" placeholder="Covered Area" autocomplete="off" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?>  name="coveredAreaUnit" id="coveredAreaUnit" style="height:35px; width:100px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?>  value="<?php echo $properties['plotLandArea'] ?>" type="text"  id="plotLandArea" name="plotLandArea" placeholder="Plot/Land Area" autocomplete="off" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> name="plotLandAreaUnit" id="plotLandAreaUnit" style="height:35px; width:100px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> id="propertycity" name="propertycity" onchange="getLocality(this)" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
                <option value="" >--Select--</option>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select <?php echo ($properties['pstatus']=='expired' || $properties['pstatus']=='moderator')?'':'disabled="disabled"' ?> id="propertyarea" name="propertyarea" onchange="changeAreUpdate(this)" style="height:35px; width:200px; color:#000066; font-size:16px; font-family:'Times New Roman', Times, serif;">
                <option value="">--Select--</option>
