...
<form class="form-horizontal" method="post" id="addproject" enctype="multipart/form-data" onsubmit="return validateprojectform('<?php echo isset($project)?'update':''?>');">
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" value="<?php echo isset($project['name'])?$project['name']:'' ?>" id="projecttitle" name="projecttitle" placeholder="Project Title" autocomplete="off">
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text"  value="<?php echo isset($project['projectName'])?$project['projectName']:'' ?>" id="projectcomptitle" name="projectcomptitle" placeholder="Company Name" autocomplete="off">
        </div>
    </div>
    <div class="control-group " >
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input  value="<?php echo isset($project['coveredArea'])?$project['coveredArea']:'' ?>" type="text"  id="projectcoveredarea" name="coveredarea" placeholder="Covered Area" autocomplete="off">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input value="<?php echo isset($project['price'])?$project['price']:'' ?>" type="text" id="projectprice" name="projectprice" placeholder="Price" autocomplete="off">&nbsp;Rs.
        </div>
    </div>
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" value="<?php echo isset($project['totalFloor'])?$project['totalFloor']:'' ?>" id="projecttotalfloors" name="totalfloors" placeholder="Total floors" autocomplete="off">
        </div>
    </div>
    <div class="control-group">
        <label class="control-label" for="projectdescription">Description</label>
        <div class="controls">
            <textarea id="projectdescription" name="projectdescription" rows="5" cols="20"><?php echo isset($project['description'])?$project['description']:'' ?></textarea>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" value="<?php echo isset($project['description'])?$project['location']:'' ?>" id="projectlocation" name="projectlocation" placeholder="Project Location" autocomplete="off">
        </div>
    </div>
