    ...
    <div class="hed">
        ...
        <div class="box">
            ...
            <div class="welcome"  style="float:right;">
                <p style="float:right;"><b> WELCOME: <font color="green"><?php echo $_SESSION['userdata']['name'] ?> </font></b> &nbsp &nbsp &nbsp &nbsp <a href="<?php echo BASE_URL ?>user/logout"> Logout </a> </p>
            </div>
            <!--<div class="buttons">
                <div class="button1">
